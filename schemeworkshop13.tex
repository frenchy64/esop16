...
object \object{} and flow proposition {\flowprop {\prop{}}}.
...
{ \judgementfour {\propenv{}} {\hastype {\x{}} {\t{}}} {\filterset {{\notprop {\falsy} {\x{}}}} {{\isprop {\falsy} {\x{}}}}}
             {\x{}}}

\infer [T-True]
{}
{ \judgementfour {\propenv{}} {{\hastype {\true{}} {\True{}}}} {{\filterset {\topprop{}} {\botprop{}}}} {\emptyobject{}} }

\infer [T-False]
{}
{ \judgementfour {\propenv{}} {{\hastype {\false{}} {\False{}}}} {\filterset {\botprop{}} {\topprop{}}} {\emptyobject{}} }

\infer [T-Nil]
{}
{ \judgementfour {\propenv{}} {{\hastype {\nil{}} {\Nil{}}}} {\filterset {\botprop{}} {\topprop{}}} {\emptyobject{}} }

\infer [T-Do]
{ \judgementfour {\propenv{}} {\hastype {\e1} {\t1}} {\filterset {\thenprop {\prop{1}}} {\elseprop {\prop1}}} {\object{1}} 
\\\\
  \judgementfour {\propenv{}, {\orprop {\thenprop {\prop{1}}} {\elseprop {\prop{1}}}}}
                 {\hastype {\e{}} {\t{}}} {\filterset {\thenprop {\prop{}}} {\elseprop {\prop{}}}} 
                 {\object{}}
  }
{ \judgementfour {\propenv{}} {\hastype {\doexp {\e1} {\e{}}} {\t{}}} {\filterset {\thenprop {\prop{}}} {\elseprop {\prop{}}}} {\object} 
             }

\infer [T-If]
{ \judgementfour {\propenv{}} {\hastype {\e1} {\t{1}}} {\filterset {\thenprop {\prop{1}}} {\elseprop {\prop{1}}}}
                 {\object{1}} 
             \\\\
  \judgementfour {\propenv{}, {\thenprop {\prop{1}}}}
                 {\hastype {\e2} {\t{}}} {\filterset {\thenprop {\prop{2}}} {\elseprop {\prop{2}}}}
                 {\object{}}
  \\\\
  \judgementfour {\propenv{}, {\elseprop {\prop{1}}}}
                 {\hastype {\e3} {\t{}}} {\filterset {\thenprop {\prop{3}}} {\elseprop {\prop{3}}}}
                 {\object{}}
             }
{ \judgementfour {\propenv{}} {\hastype {\ifexp {\e1} {\e2} {\e3}} {\t{}}} 
                 {\filterset {\orprop {\thenprop {\prop{2}}} {\thenprop {\prop{3}}}} 
                             {\orprop {\elseprop {\prop{2}}} {\elseprop {\prop{3}}}}}
                 {\object{}} }

\infer [T-Let]
{ \judgementfour {\propenv{}} {\hastype {\e{1}} {\s{}}} {\filterset {\thenprop {\prop{1}}} {\elseprop {\prop{1}}}}
             {\object{1}}
  \\\\
  \judgementfour {\propenv{}, {\isprop {\s{}} {\x{}}}, 
              {\impprop {\notprop {\falsy} {\x{}}} {\thenprop {\prop{1}}}}, 
              {\impprop {\isprop {\falsy} {\x{}}} {\elseprop {\prop{1}}}}}
             {\hastype {\e{}} {\t{}}} {\filterset {\thenprop {\prop{}}} {\elseprop {\prop{}}}}
             {\object{}} 
             }
{ \judgementfour {\propenv{}} {\hastype {\letexp {\x{}} {\e{1}} {\e{}}} {\t{}}}
...
\infer [T-Throw]
{ \judgementfour {\propenv{}} {\hastype {\e{}} {\Throwable}} {\filterset {\thenprop {\prop{}}} {\elseprop {\prop{}}}}
                 {\object{}}
}
{ \judgementfour {\propenv{}} {\hastype {\throwexp {\e{}}} {\Bottom}} {\filterset {\botprop} {\botprop}}
             {\emptyobject{}} }

\infer [T-App]
{ \judgementfour {\propenv{}} {\hastype {\e{}} {\Arrow {\hastype {\x{}} {\s{}}}
                                                       {\t{}}
                ...
                {\object{}}
  \\\\
  \judgementfour {\propenv{}}
                 {\hastype {\ep{}} {\s{}}}
                 {\filterset {\thenprop {\propp{}}}
                             {\elseprop {\propp{}}}}
                 {\objectp{}} 
}
{ \judgementfour {\propenv{}} {\hastype {\appexp {\e{}} {\ep{}}}
                                        {\replacefor {\t{}}
                                                     {\objectp{}}
                                                     {\x{}}}}
