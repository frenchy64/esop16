...
$x$ is represented as $x$; $\appexpone{\ccclass{\appexp{\makekw{lunch}}{m}}}$ as ${\path{\classpe{}}{\path{\keype{\makekw{lunch}}}{m}}}$;
$42$ has no representation, called \emptyobject{}.

This symbolic representation called the \emph{object}---\emptyobject{} is the
\emph{empty object}.
...
\paragraph{Logical system in action} Using our two facts, T-LocalProve demands
...
and object \object{}, and rewrites to \ep{}. We write 
