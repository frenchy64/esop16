...
We can also finally define \nil{} test

\begin{minted}{clojure}
(ann nil? (Pred nil))
(defn nil? [x]
  (isa? (class (class x)) Class))
\end{minted}

with the proposition set 
\isacompare{\s{}}{\classpe{}({\path{\classpe{}}{\x{}}})}{\Value{\Class}}{\filterset{\isprop{\Class}{\path{\classpe{}}{\x{}}}}{\notprop{\Class}{\path{\classpe{}}{\x{}}}}},
