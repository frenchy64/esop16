...
(let [path (defmulti [Any -> (U nil String)] class)]
  (let [path (defmethod path String [x] x)]
    (let [path (defmethod path File [^File x] 
      ...
      (path "dir/a")))) ;=> "a"
\end{minted}
where subsequent bindings in the binder is sugar for nested let expressions.

The syntax for multimethods is given in \figref{main:figure:mmsyntax}.
{\MultiFntype {\s{}} {\sp{}}} is the type of multimethods with \emph{interface type}
{\s{}} and \emph{dispatch function type} {\sp{}}.
The expression {\createmultiexp {\s{}} {\e{}}} expression creates a multimethod
with interface type \s{} and dispatch function \e{}.
The expression {\extendmultiexp {\e{m}} {\e{v}}{\e{f}}}
takes multimethod \e{m} and returns a new multimethod with an extended dispatch
table from dispatch value {\e{v}} to {\e{f}}.
The value {\multi {\v{}} {\disptable{}}} is the runtime value of a multimethod
with dispatch function {\v{}} and dispatch table {\disptable{}}.

The typing rules are in \figref{main:figure:mmsyntax}.
The T-DefMulti rule checks to ensure the type of dispatch function
is a function that has at least as permissive a parameter type
as the interface type.

For example, let us check the \defmultiliteral{} from our translation of \egref{example:rep}
using T-DefMulti.
...
environment like we sketched in \egref{example:incmap}.
We use \isacompareliteral{} to infer the proposition for this method.

Let us continue with the next line of the translation of \egref{example:rep}.
From our previous line we have \propenvp{} = \propenv{},{\isprop{\MultiFntype {\s{}}{\sp{}}}{path}}.
$$
\judgement{\propenvp{}}
{\hastype
  ...
  {\MultiFntype {\s{}}{\sp{}}}}{\filterset{\topprop{}}{\botprop{}}}{\emptyobject{}}
$$
We know \emph{prop} is a multimethod by \propenvp{}, so now we check the body.
$$
\judgement{\propenvp{},{\isprop{\Top}{\x{}}},{\isprop{\String}{\x{}}}}
{\hastype
  {\x{}}
  {\String}}{\filterset{\topprop{}}{\botprop{}}}{\emptyobject{}}
$$
This is checked by T-Local since {\inpropenv{\propenvp{},{\isprop{\Top}{\x{}}},{\isprop{\String}{\x{}}}}{\isprop{\String}{\x{}}}}.
The new proposition {\isprop{\String}{\x{}}} was inferred by 
$$
...
The next line is similarly. The final line is checked by T-App because
subtyping for multimethods (\figref{main:figure:mmsyntax}), specifically S-PMultiFn
says that {\MultiFntype {\s{}}{\sp{}}} can be upcast to its interface type {\s{}}.
Since {\s{}} has parameter type \Top{}, this holds trivially.
...
to obtain a method. The call to \getmethodliteral{} only returns a value
if there is exactly one method such that the corresponding dispatch value
is compatible with the current result of the dispatch function by \isaopsemliteral{}.
Finally we return the result of applying the obtained method and the original evaluated argument.
