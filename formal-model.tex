...
the interesting rules with the complement natural number predicate
...
uses 
\constanttypeliteral{} (\figref{main:figure:constanttyping})
to type constants.
\numberhuh{} is a predicate over the natural numbers, and
