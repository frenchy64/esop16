...
In \egref{example:getparent-direct-constructor}, \clj{(.getParent (new File "a/b"))}
translates to
...
\figref{main:figure:mmexample}
is the translation of \egref{example:hi-multimethod} to \lambdatc{}.
%\begin{minted}{clojure}
%(ann hi [Kw -> Str])
