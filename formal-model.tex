...
of type \False or \Nil. Naturally, the `else' proposition $\isprop{\falsy{}}{o}$---which
is true when $o$ is a false value---
says $o$ is either \False or \Nil.

The pair of propositions are called a \emph{proposition set}, written {\filterset{\thenprop{\prop{}}}{\elseprop{\prop{}}}}.
