...
\emph{occurence typing}, its approach to statically reasoning about
predicate tests. However, in adapting the type system to Clojure,
changes and extensions are required to accomodate both additional
...
heterogenous dictionary types. Third, multimethods provide extensible
operations, and their Clojure semantics turns out to have a surprising
synergy with the underlying occurence typing framework.
