...
\begin{lemma}[Paths are independent] \label{lemma:pathindependent}
  If \inopenv{\openv{}}{\object{}}{\v{}},
     \inopenv{\openv{}}{\path{\pathelem{}}{\object{}}}{\vp{}},
     and \inopenv{\openv{1}}{\objectp{}}{\v{}} then
       \inopenv{\openv{1}}{\path{\pathelem{}}{\objectp{}}}{\vp{}}
 \begin{proof}
   TODO
 \end{proof}
\end{lemma}
...
\begin{definition} \label{definition:consistentwith}
  ...
  and $\forall$ \object{} in \t{}, either \object{} = \emptyobject{}, or \object{} = \x{} or 
\inopenvnoeq{\openv{}}{\object{}} = {\inopenvnoeq{\openv{1}}{\object{}}}.
\end{definition}
               ...
               \item otherwise \object{2} = {\path {\pathelem{2}} {\y{}}}, where,
                ...
                \object{} = {\replacefor {\path {\pathelem{f}} {\x{}}}
                 ...
                 \inopenv {\extendopenv {\openv{c}} {\x{}} {\v{2}}}
                          {\path {\pathelem{f}} {\x{}}}
                          {\v{}}
                 and by the induction hypothesis on {\e{2}} that 
                 \inopenv{\openv{}}{\object{2}}{\v{2}},
                 so we can apply lemma \ref{lemma:pathindependent}
                 to derive
