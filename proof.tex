...
\begin{lemma}[Equal types] \label{lemma:equaltypes}
  If
  \begin{itemize}
    \item
      \judgement{\propenv{}}{\hastype{\e{}}{\t{}}}{\filterset{\thenprop{\prop{}}}{\elseprop{\prop{}}}}{\object{}},
    \item
     \judgement{\propenv{}}{\hastype{\ep{}}{\tp{}}}{\filterset{\thenprop{\propp{}}}{\elseprop{\propp{}}}}{\objectp{}},
    \item
     \satisfies{\openv{}}{\propenv{}},
    \item
     \opsem{\openv{}}{\e{}}{\v{}},
    \item
     \opsem{\openv{}}{\ep{}}{\vp{}}, and
    \item \v{} = \vp{}
  \end{itemize}
  then
      \judgement{}{\hastype{\vp{}}{\t{}}}{\filterset{\thenprop{\prop{}}}{\elseprop{\prop{}}}}{\object{}},
...
\begin{lemma}[IsA Equal] \label{lemma:isa}

  If
  \begin{itemize}
    \item
      \judgement{\propenv{}}{\hastype{\e{1}}{\s{}}}{\filterset{\thenprop{\prop{1}}}{\elseprop{\prop{1}}}}{\object{1}},
    \item
     \judgement{\propenv{}}{\hastype{\e{2}}{\t{}}}{\filterset{\thenprop{\prop{2}}}{\elseprop{\prop{2}}}}{\object{2}},
    \item
     \satisfies{\openv{}}{\propenv{}},
    \item
     \opsem{\openv{}}{\e{1}}{\v{}},
    \item
     \opsem{\openv{}}{\e{2}}{\v{}},
    \item
      \isaopsem{\v{1}}{\v{2}} = {\true{}}, and
    \item
      \isacompare{\s{}}{\object{2}}{\t{}}{\filterset{\thenprop{\prop{}}}{\elseprop{\prop{}}}}
  \end{itemize}
  then
  either {\istrueval{\v{b}}} and \satisfies{\openv{}}{\thenprop{\prop{}}}
  or     {\isfalseval{\v{b}}} and \satisfies{\openv{}}{\elseprop{\prop{}}}.
\begin{proof}
  By cases on {\v{b}}.

  \begin{case}[{\istrueval{\v{b}}}]
    \thenprop{\prop{}} = {\replacefor{\isprop{\t{}}{\x{}}}{\object{2}}{\x{}}}

  By cases on the definition of \isaopsemliteral.

  \begin{itemize}
    \item[]
  \begin{subcase} \v{1} = \v{2}

    By lemma \ref{lemma:equaltypes} we know
     \judgement{}{\hastype{\v{1}}{\t{}}}{\filterset{\thenprop{\prop{2}}}{\elseprop{\prop{2}}}}{\object{2}},
  \end{subcase}
  \end{itemize}
    \item \v{1} = \class{1} and \v{2} = \class{2} where \issubtype{}{1}{\class{1}}{\class{2}}
   may be be safely upcast to the same type as down {\object{1}}.
  \end{case}
\end{proof}
\end{lemma}
...
\begin{case}[T-IsA]\e{} = {\isaapp {\e{1}} {\e{2}}},
  ...
  For part 2, first we consider if \istrueval{\v{}}
  then {\satisfies{\openv{}}{\replacefor{\isprop{\t{2}}{\x{}}}{\object{1}}{\x{}}}}. By the definition
  of \isaopsemliteral if \istrueval{\v{}} then either

  \begin{itemize}
    \item \v{1} = \v{2}, 
      which implies
      {\opsem{\openv{}}{\e{1}}{\v{2}}},
      and since {\opsem{\openv{}}{\e{2}}{\v{2}}}
      then either {\opsem{\openv{}}{\e{1}}{\e{2}}} or {\opsem{\openv{}}{\e{2}}{\e{1}}},
      which implies \judgement{\propenv{}}{\hastype{\e{1}}{\t{2}}}
                                                {\filterset {\thenprop {\prop{1}}}
                                                            {\elseprop {\prop{1}}}}
                                                          {\object{1}},
                          so {\satisfies{\openv{}}{\replacefor{\isprop{\t{2}}{\x{}}}{\object{1}}{\x{}}}}, or
    \item \v{1} = \class{1} and \v{2} = \class{2} where {\issubtypein{}{\class{1}}{\class{2}}}.
      The interesting case is where \object{1} is non-empty, as in \isaapp{\appexp{\classconst{}}{\y{}}}{\Keyword{}}
      where \object{1} = {\path{\classpe{}}{\y{}}}.
  \end{itemize}
