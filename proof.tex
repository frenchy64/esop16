...
\begin{proof}
  ...
  \begin{case}[\classconst] \const{} = \classconst,
   ...
   \begin{itemize}
     \item[] \begin{subcase}[Class value]
               \v{} = {\classvalue{\class{}} {\overrightarrow {\classfieldpair{fld} {\v{}}}}},
...
\begin{subcase}[B-BetaClosure]
  ...
  \opsem {\openv{}}
         ...
         then
{ \judgement {\propenv_{c}, {\isprop {\s{}} {\x{}}}}
            {\hastype {\e{b}} {\t{f}}}
             {\filterset {\thenprop {\prop{f}}}
                         {\elseprop {\prop{f}}}}
             {\object{f}}}
         where \satisfies{\propenv_{c}, {\isprop {\s{}} {\x{}}}}{\extendopenv {\openv{c}} {\x{}} {\v{2}}}.
         Since 
  \opsem {\extendopenv {\openv{c}} {\x{}} {\v{2}}}
         {\e{b}}
         {\v{}},
  ...
  \opsem {\openv{}}
         ...
         then either 
                              \object{} = {\replacefor {\object{f}}
                                                ...
                                                {\x{}}}
                                                where
         \inopenv {\openv{}} {\replacefor {\object{f}}
                              {\object{2}}
                              {\x{}}} {\v{}}
