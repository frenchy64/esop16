...
\begin{lemma}[Equal types] \label{lemma:equaltypes}
  ...
  \begin{itemize}
    ...
    \item
     \opsem{\openv{}}{\e{1}}{\v{1}},
    \item
     \opsem{\openv{}}{\e{2}}{\v{2}}, and
    \item \v{1} = \v{2}
  \end{itemize}
  then
  \begin{itemize}
    \item
      \judgement{}{\hastype{\v{2}}{\s{}}}{\filterset{\thenprop{\prop{1}}}{\elseprop{\prop{1}}}}{\object{1}}, and
    \item
...
\begin{lemma}[IsA] \label{lemma:isa}
