...
\end{lstlisting}
\caption{A simple Typed Clojure program (delimiter colors: {\color{interop}Java interoperation}, {\color{types}type annotation},
  {\color{invoke}function invocation (black)}, {\color{red}collection literals}, {\color{mygray}miscellaneous})}
\label{fig:ex1}
\end{figure*}
