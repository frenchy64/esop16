...
\begin{figure}[t!]
\inputminted[firstline=5,lastline=12]{clojure}{code/demo/src/demo/ex-intro.clj}
...
figure~\ref{fig:ex1}. Here, the \texttt{tostr} multimethod dispatches
...
second. The method for \texttt{File} uses Java interoperation to call
the \texttt{.getPath} method, and Typed Clojure uses the type
information to help determine which JVM method call to construct.
...
flexible \textbf{heterogenous maps}, in which mandatory, optional, and
...
%% then obtains the parent by making a Java method call.
 ...
 The remainder of this papers begins with an example-driven
