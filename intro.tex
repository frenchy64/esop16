...
the JVM. As a result, it has an extensive base of existing untyped
programs, whose developers can benefit from Typed Clojure. As
...
leading to automatic type-enforced
...
type.  Typed Clojure offers an opt-in mode that
resolves JVM overloading, avoiding expensive runtime reflective calls.

Finally, high-performance immutable dictionaries
are the most common Clojure data structure,
which programmers repurpose liberally.
...
\noindent
 ...
 in the full implementation of Typed Clojure---\coretyped{}---in \secref{sec:experience}. 
