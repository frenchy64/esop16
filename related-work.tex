...
Optional types, requiring less implementation effort and avoiding any
runtime cost, have been widely adopted in industry, including Hack, an
extension to PHP~\cite{hack}, and Flow~\cite{flow} and
TypeScript~\cite{typescript}, two extensions of JavaScript. These
systems all support some form of occurrence typing, but not in the
