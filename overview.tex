...
The typed \clj{fn} has optional annotations by following a parameter
or binding vector by \clj{:-} and a type.
...
\begin{exmp}
\inputminted[firstline=5,lastline=31]{clojure}{code/demo/src/demo/eg5.clj}
\end{exmp}
