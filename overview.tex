...
In the first method, the dispatch value is the concrete class \clj{Long}, a subtype
of \clj{Int}, and the second \clj{nil}, the sentinel value for a failed map lookup.
...
\emph{must} be a present and mapped to an \clj{Int},
