...
Looking up \clj{:a} simply returns the associated type.
...
We take advantage of this to infer a better type for lookups on known absent keys.
...
\begin{Code}
\begin{exmp}
\inputminted[firstline=17,lastline=23]{clojure}{code/demo/src/demo/hmap_path.clj}
\end{exmp}
\end{Code}

Typed Clojure knows that this \clj{merge} will preserve the entries
of the left hand map.

\begin{Code}
\begin{exmp}
\inputminted[firstline=25,lastline=25]{clojure}{code/demo/src/demo/hmap_path.clj}
\end{exmp}
\end{Code}
