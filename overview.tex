...
constructor arguments, such as to @clj{.getParent}
...
\clj{if} tests, provide the compositional approach we need.
...
'{:Meal ':combo :meal1 Order :meal2 Order}
\end{minted}
which is an appropriate argument for the recursive call.
...
a \clj{:combo} meal, and deduce the type:
\begin{minted}{clojure}
...
\end{minted}
Since \clj{o} is originally an \clj{Order}, this simplifies to a \clj{:combo} meal, 
\begin{minted}{clojure}
'{:Meal ':combo :meal1 Order :meal2 Order}
\end{minted}
