...
for \clj{defmethod} expressions
did not help to type check these particular methods.
In our experience porting other libraries this is unusual, and
the dispatch performed by these multimethods naturally had all keys in common.
