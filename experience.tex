...
After a 2 year trial, the second case study  disabled type checking~\cite{CircleCIBlog}
citing issues with the checker implementation.% We summarise the main issues.

\smallsection{Performance}
Rechecking files with transitive dependencies is expensive since they all must be rechecked.
