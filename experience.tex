...
%Of note, the 41 (44\%) unchecked vars are mainly due to partially complete porting to Typed Clojure, but in some cases due to unannotated third-party libraries.
...
%fields. 
%35 methods are overriden to return non-nil, 
...
%78\% of var definitions are unchecked, either by an explicit \clj{:no-check} annotation
...
%The CircleCI code base contains only 26 multimethods total
%in 55,000 lines of mixed untyped-typed Clojure code.
%a low number in our experience.
%
%Only 1 Java method 
%is overridden to accept nil, suggesting that
